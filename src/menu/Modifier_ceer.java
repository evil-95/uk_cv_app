 ...
 * @author LENOVO
 */
public class Modifier_ceer extends javax.swing.JFrame {

    /**
     * Creates new form Modifier_ceer
     */
    public Modifier_ceer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Créaction de CV");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modifier_ceer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modifier_ceer().setVisible(true);
            }
        });
    }
